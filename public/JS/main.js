(() => {
  ...
  const localTitle = document.querySelector(".local-nav-links-a");
  const localTitle2 = document.querySelector(".local-nav-links-b");
  const scrollVar = document.querySelector(".scroll");
  ...
  const sceneInfo = [
    {
      ...
      objs: {
        ...
        canvas: document.querySelector("#video-canvas-0"), // 캔버스
        context: document.querySelector("#video-canvas-0").getContext("2d"),
        videoImages: [], // 이미지를 담을 빈 객체
      },
      values: {
        videoImagesCount: 335, // 이미지 개수
        imageSequence: [0, 334], // 이미지 순서
    ...
    },
    {
      ...
      objs: {
        ...
        messageA: document.querySelector("#scroll-section-2 .main-message2.a"),
        messageB: document.querySelector("#scroll-section-2 .main-message2.b"),
        messageC: document.querySelector("#scroll-section-2 .main-message2.c"),
        messageD: document.querySelector("#scroll-section-2 .main-message2.d"),
  ...
  function checkLocal() {
    if (currentScene === 1 || currentScene === 2 || currentScene === 3) {
      ...
      localTitle.style.color = "white";
      localTitle2.style.color = "white";
    }
  }
  ...
  function setLayout() {
    ...
    // 현재 스크롤 위치보다 토탈이 커지면 현재 i 를 current로 변경하고 break
  ...
  function playAnimation() {
    ...
    switch (currentScene) {
      ...
      //   values.messageA_opacity_out[2].start =
      //     values.messageA_opacity_in[2].end + 0.1;
      //   values.messageA_opacity_out[2].end =
      //     values.messageA_opacity_out[2].start + 0.1;
  ...
  function scrollLoop() {
    ...
    if (delayedYOffset < prevScrollHeight) {
      enterNewScene = true;
      if (currentScene === 0) return; // 브라우저 바운스 효과로 currentScene 마이너스 방지
      currentScene--;
      document.body.setAttribute("id", `show-scene-${currentScene}`);
    }
